                    ...
                    <div class="panel panel-default hour-trend">
                        ...
                        <div class="panel-body tab-content mTop40">
                            <div class="p4pCountLeft">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="p4pWidenedChart" :timermillisec="0" :service="service.double" chartTitle="第一个玫瑰图"></chart-tendency>
                            </div>
                            <div class="p4pCountRig">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="p4pLineChart1" :timermillisec="0" :service="service.youkeLine" chartTitle="第二个折线图"></chart-tendency>
                            </div>

                            <div class="p4pCountLeft">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="p4pLineChart2" :timermillisec="0" :service="service.youkeLine" chartTitle="第三个折线图"></chart-tendency>
                            </div>
                            <div class="p4pCountRig">
                            ...
                            <div class="p4pCountLeft">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="wordCloudChart" :timermillisec="0" :service="service.double" :resetYAxisBeforeRedraw="false" chartTitle="第五个top云词"></chart-tendency>
                            </div>
                            <div class="p4pCountRig">
                        ...
                        <div class="panel-body tab-content mTop40">
                            ...
                            <div class="p4pCountRig">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="p4pLineChart4" :timermillisec="0" :service="service.youkeLine.clue" chartTitle="第八个折线图"></chart-tendency>
                            </div>
                        ...
                        <div class="panel-body tab-content mTop40">
                            ...
                            <div class="p4pCountLeft" style="height:450px;">
                                <!-- <chart-tendency :isShow="true" :chartFlag="false" ref="vennChart" :timermillisec="0" :service="service.youkeLine.clue" chartTitle="第十一个韦恩图"></chart-tendency> -->
                            </div>
                            <div class="p4pCountRig">
                            ...
                            <div class="p4pCountLeft">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="pyramidChart" :timermillisec="0" :service="service.jingzita" chartTitle="第十三个金字塔图"></chart-tendency>
                            </div>
                            <!-- <div class="p4pCountRig">
                                <chart-tendency :isShow="true" :chartFlag="false" ref="wordCloudChart4" :timermillisec="0" :service="service.double" :resetYAxisBeforeRedraw="false" chartTitle="第十个top云词"></chart-tendency>
                            </div> -->
