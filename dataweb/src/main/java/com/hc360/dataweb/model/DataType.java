...
/**互通宝**/
    P4PXIANJINCHARGETOTAL("现金充值",354),
    P4PFANDIANJINCHARGETOTAL("返点金充值",355),
    P4PXUNICHARGETOTAL("虚拟充值",356),
    P4PALLCHARGETOTAL("累计充值金额",357),


    P4PXIANJINEXPENDTOTAL("现金消耗",358),
    P4PFANDIANJINEXPENDTOTAL("返点金消耗",359),
    P4PXUNIEXPENDTOTAL("虚拟消耗",360),
    ...
    P4PXIANJINBALANCEUSERS("仅现金余额",368),
    P4PFANDIANJINBALANCEUSERS("仅返点金余额",369),
    P4PXUNIBALANCEUSERS("仅虚拟余额",370),
